...
import ai.inquery.server.web.api.controller.rdb.request.TableDeleteRequest;
...
public class ViewController {
    ...
    public WebPageResult<TableVO> list(@Valid TableBriefQueryRequest request) {
        ListResult<Table> tableDTOPageResult = viewService.views(request.getDatabaseName(), request.getSchemaName(), request.isRefresh());
