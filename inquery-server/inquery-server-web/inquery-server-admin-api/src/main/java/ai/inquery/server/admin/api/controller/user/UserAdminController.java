...
import ai.inquery.server.admin.api.controller.user.converter.UserAdminConverter;
...
import ai.inquery.server.domain.api.param.team.TeamPageQueryParam.OrderCondition;
...
public class UserAdminController {
     ...
     */
    @PostMapping("/update")
    public DataResult<Long> update(@Valid @RequestBody UserUpdateRequest request) {
