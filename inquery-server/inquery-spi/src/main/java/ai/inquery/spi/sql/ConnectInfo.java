...
public class ConnectInfo {
    ...
    public String getKey() {
        // Simplified key: use only dataSourceId and loginUser
        // This allows connection reuse across different databases/schemas
        // (Snowflake and most modern DBs can query any schema with same connection)
        return "loginUser:" + loginUser + "_dataSourceId:" + dataSourceId + "_consoleId:" + consoleId;
    }
