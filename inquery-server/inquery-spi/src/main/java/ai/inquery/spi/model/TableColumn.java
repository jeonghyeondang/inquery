...
//    private String typeName;
    ...
    /**
     * Nested/child columns for complex types like BigQuery STRUCT/RECORD
     * When columnType is RECORD or STRUCT, this contains the nested fields
     */
    private List<TableColumn> children;

    /**
     * Parent column name for nested fields (used for BigQuery STRUCT fields)
     * e.g., if field_path is "address.city", parentColumnName would be "address"
     */
    private String parentColumnName;

    /**
     * Full field path for nested columns (e.g., "address.city.zip")
     * Used primarily for BigQuery nested structures
     */
