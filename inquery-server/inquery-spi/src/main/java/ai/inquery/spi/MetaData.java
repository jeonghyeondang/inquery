...
public interface MetaData {
    ...
    /**
     * Querying all foreign keys in a schema.
     * Used for ERD (Entity Relationship Diagram) visualization.
     *
     ...
     */
    List<ForeignKeyInfo> foreignKeys(Connection connection, String databaseName, String schemaName);

    /**
     * Querying foreign keys for a specific table.
     *
     * @param connection database connection
     * @param databaseName database name
     * @param schemaName schema name (optional)
     * @param tableName table name
     * @return list of foreign key relationships for the table
     */
    List<ForeignKeyInfo> foreignKeys(Connection connection, String databaseName, String schemaName, String tableName);
