...
public class CacheKey {
    ...
    public static String getViewsKey(Long dataSourceId, String databaseName, String schemaName) {
        StringBuffer stringBuffer = new StringBuffer("views_dataSourceId_" + dataSourceId);
        if (!StringUtils.isEmpty(databaseName)) {
            stringBuffer.append("_databaseName_" + databaseName);
        }
        if (!StringUtils.isEmpty(schemaName)) {
