...
public class CacheManage {
    private static final String PATH = System.getProperty("user.home") + File.separator + ".inquery"
        + File.separator
        + "cache" + File.separator + "inquery-ehcache-data_" +System.getProperty("spring.profiles.active");
