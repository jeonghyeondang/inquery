...
public interface TableService {
     ...
     * @param param query param with dataSourceId
     * @return list of all tables with database and schema information
     */
    ListResult<SimpleTable> queryAllTablesFromAllDatabases(TablePageQueryParam param);
}
