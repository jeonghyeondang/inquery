...
import ai.inquery.plugin.db2.builder.DB2SqlBuilder;
import ai.inquery.plugin.db2.constant.SQLConstant;
import ai.inquery.plugin.db2.type.DB2ColumnTypeEnum;
import ai.inquery.plugin.db2.type.DB2DefaultValueEnum;
import ai.inquery.plugin.db2.type.DB2IndexTypeEnum;
