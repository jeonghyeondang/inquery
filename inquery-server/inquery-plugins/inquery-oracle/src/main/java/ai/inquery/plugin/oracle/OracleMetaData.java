...
import ai.inquery.plugin.oracle.builder.OracleSqlBuilder;
import ai.inquery.plugin.oracle.type.OracleColumnTypeEnum;
import ai.inquery.plugin.oracle.type.OracleDefaultValueEnum;
import ai.inquery.plugin.oracle.type.OracleIndexTypeEnum;
import ai.inquery.plugin.oracle.value.OracleValueProcessor;
...
import ai.inquery.spi.util.SortUtils;
...
//                }
    ...
    public Procedure procedure(Connection connection, @NotEmpty String databaseName, String schemaName,
        ...
        return SQLExecutor.getInstance().execute(connection, sql, resultSet -> {
            ...
            String procedureBody = bodyBuilder.toString().trim(); // Trim trailing whitespace
