package ai.inquery.plugin.postgresql.builder;

import ai.inquery.plugin.postgresql.type.PostgreSQLColumnTypeEnum;
import ai.inquery.plugin.postgresql.type.PostgreSQLIndexTypeEnum;
...
public class PostgreSQLSqlBuilder extends DefaultSqlBuilder {
    ...
    public String buildCreateSequenceSql(Sequence sequence) {
        ...
        double databaseProductVersion = Double.parseDouble(InqueryContext.getConnection().getMetaData().getDatabaseProductVersion());
        StringBuilder sqlBuilder = new StringBuilder();
